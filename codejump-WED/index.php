  ...
  <?php get_header(); ?>
    <main>
      ...
      <div class="main-visual">
        <img src="img/mainvisual.jpg" alt="光と緑に包まれたオフィスで、Web制作チームが打ち合わせをしている様子" />
      </div>
            ...
            <ul>
              <li class="news-block">
                <div class="news-info">
                  ...
                  <a class="news-tag" href="index.html">NEWS</a>
                </div>
                <h3 class="news-title">
                  <a href="press.html">タイトルタイトルタイトルタイトル</a>
                </h3>
              </li>
              <li class="news-block">
                <div class="news-info">
                  <time datetime="2021-01-01">2021.01.01</time>
                  <a class="news-tag" href="index.html">PRESS</a>
                </div>
                <h3 class="news-title">
